...
from utils.models_deprecated import SimpleNet, SimpleNetA
...
from alltools.machine_learning import one_hot_decoder
...
if __name__ == '__main__':
    ...
    for subject_name in iterator:
        ...
        Y = np.concatenate([one_hot_decoder(data.session_info[['CongruentDie', 'CongruentGrow', 'Incongruent']].to_numpy()) for data in preprcessed])
